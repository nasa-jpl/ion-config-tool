    ...
    return (
      <Container fluid>
        ...
        <Row>
            ...
            <ButtonGroup>
            <h5><Badge pill bg="primary" text="light">ION Host List</Badge></h5>
              <OverlayTrigger
                placement="right"
                overlay={
                  <Tooltip id="tooltip">
                    Expand to view, create or edit ION configuration information for hosts. 
                  </Tooltip>
                }
              >
            ...
            <Col className="text-left" lg={2}><h6>ION Host Machines {hostCnt}</h6></Col>
            <Col sm={3}> 
              <ButtonGroup>
